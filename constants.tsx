...
export const TERRAINS: Terrain[] = [
  { id: 'grass', name: 'Grass', color: 'bg-lime-600/50', hexColor: '#76B947', icon: <GrassIcon /> },       // Brighter Green
  { id: 'forest', name: 'Forest', color: 'bg-emerald-950/50', hexColor: '#223C3C', icon: <TreeIcon /> },     // Darker Slate Gray
  { id: 'water', name: 'Water', color: 'bg-teal-600/50', hexColor: '#4AB4A9', icon: <WaterIcon /> },         // Teal Green
  { id: 'road', name: 'Road', color: 'bg-amber-800/50', hexColor: '#D2B48C', icon: <RoadIcon /> },         // Tan (Unchanged)
  { id: 'ruined_walls', name: 'Ruins', color: 'bg-indigo-500/50', hexColor: '#8A89A6', icon: <WallIcon /> },     // Lavender Gray
  { id: 'mountains', name: 'Mountains', color: 'bg-stone-800/50', hexColor: '#60544D', icon: <MountainIcon /> }, // Dark Taupe
];
